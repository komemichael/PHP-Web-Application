				...
				<div class="w3-row w3-flat-asbestos w3-round">
					...
					<div class="w3-col m6 l7">
						<div style="padding: 16px" class="w3-containter">
							<h3 class="w3-jumbotron">Hello <?php echo $_SESSION["login_user"]; ?></h3> 
							...
							<div class="hovercard w3-padding">
								...
								<div>
									...
									<div id="contact" class="pill">
										<br>
										<h4>Contact</h4>
										<p>For now, kome is the primary point of contact. So contact him form-data the bottom of this page</p>
									</div>
							...
							<div class="hovercard w3-padding">
								...
								<br>
								<p class="w3-text-sand">This section is for if you wish to upload photos to be used for the ebsite. You will see the pictures in your logged in page unless you tick the checkbox to make it public</p>
							...
							<div>
								<div class="w3-hide-small w3-padding hovercard">
									If you really like the website and want me to add more features to the site, please leave a message as feedback to me at the bottom of this page and I will see if I will be able to implement it. I also like challenging tasks so please don't worry about ridiculous or hard the idea may be, thanks!
								</div>
							</div>
